...
function (_super) {
  ...
  Actions.prototype.ofType = function (type) {
    return this.asObservable().pipe(operators_1.filter(function (action) {
...
/** @class */
function () {
  function Store(initialState, reducers, effectsClasses, errorHandler) {
    if (initialState === void 0) {
      initialState = exports.defaultInitialState;
    }
    ...
    this.stateSubject = new rxjs_1.Subject();
    this.state$ = this.stateSubject.asObservable().pipe(operators_1.scan(function (acc, newVal) {
      return __assign({}, acc, newVal);
    }, initialState), operators_1.startWith(initialState), operators_1.shareReplay(1));
    this.actions$.pipe(operators_1.withLatestFrom(this.state$), operators_1.map(function (_a) {
      var action = _a[0],
          state = _a[1];
      return _this.update(reducers.reduce(function (newState, reducer) {
    ...
    rxjs_1.combineLatest.apply(null, effects).pipe( // @ts-ignore: Strict
    operators_1.mergeAll(), operators_1.filter(function (action) {
      return !!action;
    }), operators_1.catchError(function (error) {
      _this.errorHandler(error);
  ...
  Store.prototype.errorHandler = function (error) {
    /* istanbul ignore next */
    throw new Error(error);
  };

  Store.prototype.update = function (partialState) {
    ...
    if (action instanceof Array) {
      action.forEach(function (action) {
        return setTimeout(function (_) {
          return _this.actions$.next(action);
        }, 0);
      });
    } else {
...
exports.Store = Store;
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js"}],"../lib/effects.ts":[function(require,module,exports) {
"use strict";
  ...
  Object.defineProperty(Effects.prototype, "effects", {
    get: function get() {
      ...
      if (this.constructor.hasOwnProperty(exports.METADATA_KEY)) {
        // @ts-ignore: Strict
        return this.constructor[exports.METADATA_KEY].map(function (e) {
          return _this[e];
        });
      }
...
},{"./lib/state":"../lib/state.ts","./lib/effects":"../lib/effects.ts"}],"../../three-store/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../three-store/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../index.js"], null)
//# sourceMappingURL=/not-ngrx.80dfb952.js.map